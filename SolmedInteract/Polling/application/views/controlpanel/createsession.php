...
<form action="post_createsession" method="post" role="form">
	<div class="box box-primary">
		...
		<div class="box-body">
				...
				<div class="form-group has-warning">
					<input type="text" name="SessionName" class="form-control" placeholder="Session Name" maxlength="100" required autofocus />
				</div>
				<!-- Description -->
				<label>Description</label>
				<div class="form-group">
					<textarea name="Description" class="form-control" placeholder="Description" maxlength="250"></textarea>
				</div>
				<!-- Display Order -->
				<label>Display Order</label>
				<div class="form-group has-warning">
					<input type="number" name="DisplayOrder" class="form-control" placeholder="Display Order" min="1" max="9999" required />
				</div>
				<!-- Start Datetime -->
