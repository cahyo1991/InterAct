...
<form action="editfile" method="post" role="form" enctype="multipart/form-data">
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class="form-group has-warning">
				<input type="text" name="Description" class="form-control" placeholder="Description" maxlength="100" required="required" autofocus="autofocus" value="<?= $file['Description'] ?>" />
			</div>
		</div>
		<!-- /.box-body -->
		<div class="row">
